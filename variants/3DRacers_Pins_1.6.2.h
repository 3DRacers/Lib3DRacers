...
#define MOTOR_RUN_METHOD    1 //in IN/IN Mode: 0 for forward/reverse coasts, 1 for forward/reverse brake, in PH/EN: 0 for coasts when not moving, 1 for brake on stop
